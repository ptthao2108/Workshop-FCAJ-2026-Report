...
![Create bucket](/images/4-Workshop/4.3-S3-vpc/create-bucket.png)
...
![Bucket name](/images/4-Workshop/4.3-S3-vpc/bucket-name.png)

+ Leave other fields as they are (default)
+ Scroll down and choose **Create bucket**

![Create](/images/4-Workshop/4.3-S3-vpc/create-button.png) 

+ Successfully create S3 bucket.

![Success](/images/4-Workshop/4.3-S3-vpc/bucket-success.png)
...
+ First cloud journey [Lab](https://000048.awsstudygroup.com/1-introduce/) for indepth understanding of Session manager.

1. In the **AWS Management Console**, start typing ```Systems Manager``` in the quick search box and press **Enter**:

![system manager](/images/4-Workshop/4.3-S3-vpc/sm.png)

2. From the **Systems Manager** menu, find **Node Management** in the left menu and click **Session Manager**:

![system manager](/images/4-Workshop/4.3-S3-vpc/sm1.png)
...
![Start session](/images/4-Workshop/4.3-S3-vpc/start-session.png)

**Session Manager** will open a new browser tab with a shell prompt: sh-4.2 $

![Success](/images/4-Workshop/4.3-S3-vpc/start-session-success.png)
...
![Change user's dir](/images/4-Workshop/4.3-S3-vpc/cli1.png)
...
![Create file](/images/4-Workshop/4.3-S3-vpc/cli-file.png)
...
![Uploaded](/images/4-Workshop/4.3-S3-vpc/uploaded.png)
...
![Check S3](/images/4-Workshop/4.3-S3-vpc/check-s3-bucket.png)
