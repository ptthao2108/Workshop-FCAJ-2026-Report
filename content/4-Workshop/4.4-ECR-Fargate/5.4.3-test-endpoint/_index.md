...
![dns name](/images/4-Workshop/4.4-S3-onprem/dns.png)
...
![Start session](/images/4-Workshop/4.4-S3-onprem/start-session.png)
...
![user](/images/4-Workshop/4.4-S3-onprem/cli1.png)


4. Copy file to the same S3 bucket we created in section 3.2
...
![copy file](/images/4-Workshop/4.4-S3-onprem/cli2.png)
...
![check bucket](/images/4-Workshop/4.4-S3-onprem/check-bucket.png)
