...
![VPC step 1](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/vpc.1.jpg)

2. Name the VPC `lunchsync-vpc`, use CIDR `10.0.0.0/16`, and create 2 AZs, 2 public subnets, and 2 private subnets.

![VPC step 2](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/vpc.2.jpg)
...
![VPC step 3](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/vpc.3.jpg)
...
![Target Group step 5](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/tg.5.jpg)

10. After creation, confirm that `lunchsync-tg-backend` exists and currently has no registered targets.

![Target Group step 6](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/tg.6.jpg)

11. Open **EC2 > Load Balancers** and start creating a new load balancer.

![ALB step 1](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.1.jpg)

12. Choose **Application Load Balancer**.

![ALB step 2](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.2.jpg)

13. Name it `lunchsyn-alb`, choose `Internet-facing`, and keep `IPv4`.

![ALB step 3](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.3.jpg)
...
![ALB step 8](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.8.jpg)

19. Review the summary page: 2 public subnets, `80 -> 443`, and `443 -> lunchsync-tg-backend`, then create the load balancer.

![ALB step 9](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.9.jpg)
...
![ALB step 10](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.10.jpg)

21. Open the **Security** tab, verify the attached security group, and keep the ALB DNS name for the CloudFront section.

![ALB step 11](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.11.jpg)
...
![ALB step 12](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/alb.12.jpg)

23. Open **Security Groups** to review the groups in the VPC and prepare the backend group.

![Security Group step 1](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/sg.1.jpg)
...
![Security Group step 2](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/sg.2.jpg)

25. Review `redis-sg` and make sure it only allows `TCP 6379` from `backend-sg`.

![Security Group step 3](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/sg.3.jpg)

26. Review `rds-sg` and make sure it only allows `PostgreSQL 5432` from `backend-sg`.

![Security Group step 4](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/sg.4.jpg)
...
![Security Group summary](/images/4-Workshop/4.3-VPC-SecurityGroup-ALB/Screenshot%202026-04-03%20001755.jpg)
