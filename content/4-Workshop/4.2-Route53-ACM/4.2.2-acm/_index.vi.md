...
![ACM bước 1](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.1.jpg)

2. Nhập các domain cần được bảo vệ bởi chứng chỉ.

![ACM bước 2](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.2.jpg)

3. Chọn **DNS validation** để có thể xác thực thông qua Route53.

![ACM bước 3](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.3.jpg)

4. Rà soát thông tin yêu cầu và gửi request tạo chứng chỉ.

![ACM bước 4](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.4.jpg)

5. Mở các bản ghi xác thực được tạo ra và tạo hoặc xác nhận CNAME trong Route53.

![ACM bước 5](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.5.jpg)

6. Chờ đến khi quá trình xác thực hoàn tất và trạng thái chứng chỉ chuyển sang **Issued**.

![ACM bước 6](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.6.jpg)

7. Kiểm tra lại thông tin chứng chỉ trước khi gắn cho load balancer hoặc CloudFront.

![ACM bước 7](/images/4-Workshop/4.2-Route53-ACM/4.2.2-acm/acm.7.jpg)
