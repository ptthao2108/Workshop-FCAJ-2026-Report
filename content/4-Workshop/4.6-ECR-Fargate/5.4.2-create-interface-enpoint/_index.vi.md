...
![name](/images/4-Workshop/4.4-S3-onprem/s3-interface-endpoint1.png)
...
![service](/images/4-Workshop/4.4-S3-onprem/s3-interface-endpoint2.png)
...
![vpc](/images/4-Workshop/4.4-S3-onprem/s3-interface-endpoint3.png)

4. Chọn 2 subnets trong AZs sau: us-east-1a and us-east-1b

![subnets](/images/4-Workshop/4.4-S3-onprem/s3-interface-endpoint4.png)

6. Đối với Security group, chọn SGforS3Endpoint:

![sg](/images/4-Workshop/4.4-S3-onprem/s3-interface-endpoint4.png)

7. Giữ default policy - full access và click Create endpoint

![success](/images/4-Workshop/4.4-S3-onprem/s3-interface-endpoint-success.png)
