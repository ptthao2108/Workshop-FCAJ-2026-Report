...
![Route53 bước 1](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/route53.1.jpg)

2. Tại màn hình **Create hosted zone**, nhập domain `lunchsync.space`, chọn loại **Public hosted zone** rồi tạo zone.

![Route53 bước 2](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/route53.2.jpg)

3. Sau khi zone được tạo, kiểm tra lại hai record mặc định **NS** và **SOA** của `lunchsync.space`.

![Route53 bước 3](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/route53.3.jpg)
...
![ACM bước 7](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/acm.7.jpg)

12. Mở **Amazon Cognito** và chọn **Create user pool** để tạo user pool cho LunchSync.

![Cognito bước 1](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.1.jpg)
...
![Cognito bước 7](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.7.jpg)
...
![Cognito bước 8](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.8.jpg)

20. Đặt tên secret là `lunchsync/cognito` để backend có thể tham chiếu đúng secret này ở runtime.

![Cognito bước 9](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.9.jpg)
...
![Cognito bước 10](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.10.jpg)
