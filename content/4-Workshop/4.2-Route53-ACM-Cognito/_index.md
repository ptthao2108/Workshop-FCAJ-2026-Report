...
![Route53 step 1](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/route53.1.jpg)

2. In **Create hosted zone**, enter `lunchsync.space`, choose **Public hosted zone**, and create the zone.

![Route53 step 2](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/route53.2.jpg)

3. After the zone is created, review the default **NS** and **SOA** records for `lunchsync.space`.

![Route53 step 3](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/route53.3.jpg)
...
![ACM step 7](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.1-Route53-ACM/acm.7.jpg)

12. Open **Amazon Cognito** and choose **Create user pool** for LunchSync.

![Cognito step 1](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.1.jpg)
...
![Cognito step 2](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.2.jpg)
...
![Cognito step 3](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.3.jpg)

15. Reopen the new pool and confirm that `Lunchsync-App` is attached to `Lunchsync - user pool`.

![Cognito step 4](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.4.jpg)

16. Open **App client** to capture the **Client ID**, inspect the **Client secret**, and review token settings.

![Cognito step 5](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.5.jpg)

17. Open the **Sign-in** tab of the user pool and review sign-in options, MFA, and device-tracking settings.

![Cognito step 6](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.6.jpg)
...
![Cognito step 7](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.7.jpg)
...
![Cognito step 8](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.8.jpg)

20. Name the secret `lunchsync/cognito` so the backend can reference it consistently at runtime.

![Cognito step 9](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.9.jpg)
...
![Cognito step 10](/images/4-Workshop/4.2-Route53-ACM-Cognito/4.2.2-Cognito/co.10.jpg)
